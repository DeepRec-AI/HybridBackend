...
#ifndef HYBRIDBACKEND_TENSORFLOW_GRAPH_COMMON_PRUNING_H_
#define HYBRIDBACKEND_TENSORFLOW_GRAPH_COMMON_PRUNING_H_
...
#endif  // HYBRIDBACKEND_TENSORFLOW_GRAPH_COMMON_PRUNING_H_
