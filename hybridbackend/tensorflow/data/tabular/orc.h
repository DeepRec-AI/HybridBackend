...
#ifndef HYBRIDBACKEND_TENSORFLOW_DATA_TABULAR_ORC_H_
#define HYBRIDBACKEND_TENSORFLOW_DATA_TABULAR_ORC_H_
...
class OrcAccess : public TableAccess {
 public:
  OrcAccess(OpKernelContext* ctx, const TableFormat& format,
...
#endif  // HYBRIDBACKEND_TENSORFLOW_DATA_TABULAR_ORC_H_
