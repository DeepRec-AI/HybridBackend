...
#ifndef HYBRIDBACKEND_TENSORFLOW_DATA_COMMON_DATASET_H_
#define HYBRIDBACKEND_TENSORFLOW_DATA_COMMON_DATASET_H_
...
#endif  // HYBRIDBACKEND_TENSORFLOW_DATA_COMMON_DATASET_H_
