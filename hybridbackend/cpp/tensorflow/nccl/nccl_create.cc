...
REGISTER_RESOURCE_HANDLE_OP(NcclComm);

REGISTER_OP("IsNcclCommInitialized")
...
#if GOOGLE_CUDA
REGISTER_KERNEL_BUILDER(Name("NcclCommHandleOp").Device(DEVICE_GPU),
                        ResourceHandleOp<NcclComm>);

REGISTER_KERNEL_BUILDER(Name("IsNcclCommInitialized")
                            .Device(DEVICE_GPU)
...
REGISTER_KERNEL_BUILDER(
    Name("CreateNcclComm").Device(DEVICE_GPU).HostMemory("id"),
    CreateNcclCommOp);
#endif  // GOOGLE_CUDA
