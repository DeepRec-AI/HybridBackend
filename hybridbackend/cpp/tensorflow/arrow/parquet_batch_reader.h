...
#ifndef HYBRIDBACKEND_CPP_TENSORFLOW_ARROW_PARQUET_BATCH_READER_H_
#define HYBRIDBACKEND_CPP_TENSORFLOW_ARROW_PARQUET_BATCH_READER_H_
...
#endif  // HYBRIDBACKEND_CPP_TENSORFLOW_ARROW_PARQUET_BATCH_READER_H_
